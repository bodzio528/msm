...
namespace // Concrete FSM implementation
{
    ...
    BOOST_MSM_EUML_TRANSITION_TABLE((
          ...
          //  +------------------------------------------------------------------------------+
          Paused    == Playing  + pause_ev       / pause_playback  ,
          //  +------------------------------------------------------------------------------+
...
int main()
{
    ...
    auto utime = [](timeval const& begin, timeval const& end) -> long long int
    {
        return 1'000'000 * (end.tv_sec - begin.tv_sec) + (end.tv_usec - begin.tv_usec);
    };

    std::cout << "msm took in us:" <<  utime(tv2, tv1) <<"\n" <<std::endl;
