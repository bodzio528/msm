...
namespace  // Concrete FSM implementation
{
    ...
    struct player_ : public msm::front::state_machine_def<player_,my_visitable_state>
    {
        ...
        {
            typedef boost::mpl::vector<play> deferred_events;
        ...
        {
            typedef boost::mpl::vector<CDLoaded>      flag_list;
            typedef boost::mpl::vector<play> deferred_events;
            template <class Event,class FSM>
        ...
        struct Playing_ : public msm::front::state_machine_def<Playing_,my_visitable_state >
        {
            ...
            typedef boost::mpl::vector<PlayingPaused,CDLoaded>        flag_list;
            template <class Event,class FSM>
            ...
            {
                typedef boost::mpl::vector<FirstSongPlaying>      flag_list;
                template <class Event,class FSM>
        ...
        typedef msm::back::state_machine<Playing_,msm::back::ShallowHistory<boost::mpl::vector<end_pause> > > Playing;
